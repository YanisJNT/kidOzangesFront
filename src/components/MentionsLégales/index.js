...
<p>1.1 Site (ci-après « le site ») : 
 ...
 Kid-Oz-Anges est hébergé par Netlify, dont le siège social est situé 13 Rue Camille Pelletan 33150 Bordeaux.
  ...
  <h2 className="LegalNotice--subtitle"> Article 3 - Contenu du site</h2>
...
<h2 className="LegalNotice--subtitle">
...
<p>
Vos données sont collectées par la société Kid-Oz-Anges.
...
13 Rue Camille Pelletan Cenon  .
 
Ou par email, à l’adresse :
kidozanges@gmail.com    
...
<p>
Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : kidozanges@gmail.com.
Vos données sont susceptibles d’être utilisées par les partenaires de l'éditeur à des fins de prospection commerciale, si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : kidozanges@gmail.com.
...
- Cookie à l'authentification permettant la gestion des utilisateurs.
...
<p>
Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l'adresse suivante : kidozanges@gmail.com.     
</p>
        </div>
    )
}
